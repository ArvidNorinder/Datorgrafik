	...
	bool generate_mipmap)
{
	...
	// and `glGenBuffers()` that were used in assignmentÂ2,
	...
	// texels.
	// List of all the images for the 6 faces
	std::vector<std::string> faces = { posx, negx, posy, negy, posz, negz };

	// Corresponding OpenGL targets for each face
